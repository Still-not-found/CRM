...
const TABLE_HEAD = [
  ...
  { id: "asset_tag", label: "Asset Tag", alignRight: false },
  { id: "model_id", label: "Asset Type", alignRight: false },
  { id: "serial", label: "Serial", alignRight: false },
  { id: "label", label: "Model", alignRight: false },
  { id: "physical", label: "Category", alignRight: false },
  { id: "status_id", label: "Status", alignRight: false },
  // { id: "label", label: "Checked Out To", alignRight: false },
  // { id: "label", label: "Location", alignRight: false },
  // { id: "label", label: "Purchase Cost", alignRight: false },
  // { id: "label", label: "Current Value", alignRight: false },
