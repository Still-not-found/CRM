...
export default function CreateLicense(props) {
  ...
  return (
    <>
      <Helmet>
        <title>License Create | ITAM </title>
      </Helmet>
      ...
      <Container>
        ...
        <Card sx={{ overflow: "visible" }}>
          <TabContext value={tabValue}>
            ...
            >
              <Tab label="License Details" value="1" />
            </TabList>
                ...
                <Grid container columnSpacing={3}>
                  <Grid item xs={12} md={7}>
                    ...
                    >
                      ...
                      <FormGroup>
      <FormControlLabel control={<Checkbox defaultChecked />} label="Reassignable" />
    </FormGroup>
    </Grid>
    ...
    <Grid item xs={12} md={7}>
                      ...
                      <FormGroup>
      <FormControlLabel control={<Checkbox defaultChecked />} label="Maintained" />
    </FormGroup>
    </Grid>
