...
export default function CreateWorkstation(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(`${API_URL}/api/workstations`, { ...workstationData, createdBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>Workstation Create | IT Assset Management</title>
      </Helmet>
