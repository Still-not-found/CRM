...
export default function CreateNSwitch(props) {
  ...
  const handleNSwitchTabChange = (event, newValue) => {
  ...
  const validate = () => {
    ...
    if (!Boolean(nswitchData.nswitchName))
      errors.nswitchName = "NSwitch Name is required";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(`${API_URL}/api/nswitchs`, { ...nswitchData, createdBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>NSwitch Create | IT Assset Management</title>
      </Helmet>
      ...
      >
        <TabContext value={tabValue}>
          <TabList
            onChange={handleNSwitchTabChange}
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      ...
                      <TextField
                        ...
                        required
                        label="NSwitch Name"
                        value={nswitchData.nswitchName}
                        onChange={(event) => {
                          handleInputChange("nswitchName", event.target.value);
                        }}
                        error={Boolean(validationErrors.nswitchName)}
                        helperText={validationErrors.nswitchName}
                      />
                    </Grid>
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        required
                        label="No Of Points"
                        value={nswitchData.noofpoints}
                        onChange={(event) => {
                          handleInputChange("gateway", event.target.value);
                        }}
                        error={Boolean(validationErrors.noofpoints)}
                        helperText={validationErrors.noofpoints}
                      />
                    </Grid>
                          ...
                          <Grid item xs={10} md={2.7}>
                            <Autocomplete
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === nswitchData.company
                                ) || null
                              }
                          ...
                          <Grid item xs={10} md={2.7}>
                            <Autocomplete
                              value={
                                suppliers.find(
                                  (_supplier) =>
                                    _supplier.supplier_id === nswitchData.supplier
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                          ...
                          <Grid item xs={10} md={2.7}>
                            <Autocomplete
                              value={
                                locations.find(
                                  (_location) =>
                                    _location.location_id === nswitchData.location
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                          ...
                          <Grid item xs={10} md={2.7}>
                            <Autocomplete
                              value={
                                assetstatus.find(
                                  (_assetStatus) =>
                                    _assetStatus.status_id === nswitchData.statusId
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
