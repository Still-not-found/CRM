...
export default function EditLead(props) {
  ...
  return (
    <>
      <Helmet>
        <title>Lead Edit | IT Asset Management</title>
      </Helmet>
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      <Typography variant="body1" disabled="true">
                        {leadData.installedsoftware.split(',').map((item, index) => (
                          <div key={index}>
      ...
      <Grid container columnSpacing={3}>
        <Grid item xs={4} sm={12} md={12}>
          ...
          >
            <Grid item xs={4} sm={12} md={12}>
              {leadData.installedsoftware.split(',').map((item, index, array) => (
                <React.Fragment key={index}>
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            ...
                            size="small"
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === leadData.billedentity
                                ) || null
                              }
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === leadData.assignedentity
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                assetstatus.find(
                                  (_assetStatus) =>
                                    _assetStatus.status_id === leadData.assetStatus
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
      ...
      <TextField
        ...
        disabled
        label="Uploaded Invoice/PO"
        value={leadData.invoice}
        InputProps={{
          endAdornment: (
            <InputAdornment position="end">
              <IconButton
                onClick={()=>{window.open(`${API_URL}/uploads/${leadData.invoice}`, '_blank')}}
                edge="end"
              >
