...
const TABLE_HEAD = [
  ...
  { id: "registered_owner", label: "Status", alignRight: false },
  { id: "os_name", label: "Job Title", alignRight: false },
  { id: "serial", label: "ID", alignRight: false },
                  ...
                  .map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        }} align="left" onClick={()=>{navigate(`/computer_detail/${computer_id}`)}}>
                            {name}
                        </TableCell>
...
<TablePagination
      ...
      >
        <MenuItem onClick={()=>{navigate(`/computer_detail/${computerId}`)}}>
