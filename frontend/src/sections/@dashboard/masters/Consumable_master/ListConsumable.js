...
const TABLE_HEAD = [
  ...
  { id: "customer_name", label: "Category", alignRight: false },
  { id: "label", label: "Model No", alignRight: false },
  { id: "label", label: "Item No", alignRight: false },
  { id: "label", label: "Total", alignRight: false },
  { id: "label", label: "Remaining", alignRight: false },
  { id: "label", label: "Min.Qty", alignRight: false },
  { id: "label", label: "Location", alignRight: false },
  { id: "label", label: "Order Number", alignRight: false },
  { id: "label", label: "Purchase Date", alignRight: false },
  { id: "label", label: "Purchase Cost", alignRight: false },
  { id: "label", label: "In/Out", alignRight: false },
  { id: "" },
];
...
export default function ListConsumable(props){
 ...
 const breadcrumbs = [
  ...
  <Typography key="3" color='text.disabled'>
    ...
    return (
        <>
      <Helmet>
        <title> Consumables List | ITAM </title>
      </Helmet>
