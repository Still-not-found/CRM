...
export default function EditOpportunity(props) {
  ...
  const softwareDetailsArray = opportunityData.installedsoftware.split('", "');
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        await axios.get(`${API_URL}/api/opportunitys/${idToEdit}`).then((response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.put(`${API_URL}/api/opportunitys/${idToEdit}`, { ...opportunityData, purchasedate: dayjs(opportunityData.purchasedate).format("YYYY-MM-DD"),warrenty: dayjs(opportunityData.warrenty).format("YYYY-MM-DD"), updatedBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>Opportunity Edit | IT Asset Management</title>
      </Helmet>
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      ...
                      <TextField
                        ...
                        onChange={(event) => {
                          handleInputChange("opportunityName", event.target.value);
                        }}
                        error={Boolean(validationErrors.opportunityName)}
                        helperText={validationErrors.opportunityName}
                      />
                    </Grid>
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="Host Name"
                        value={opportunityData.hostname}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="OS Version"
                        value={opportunityData.osversion}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={opportunityData.osmanufacturer}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="OS Build Type"
                        value={opportunityData.osbuildtype}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={opportunityData.registeredowner}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="Product ID"
                        value={opportunityData.productid}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="BIOS"
                        value={opportunityData.biosversion}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={opportunityData.windowsdirectory}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={opportunityData.systemdirectory}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="SystemLocale"
                        value={opportunityData.systemlocale}
                        onChange={(event) => {
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      <Typography variant="body1" disabled="true">
                        {opportunityData.installedsoftware.split(',').map((item, index) => (
                          <div key={index}>
      ...
      <Grid container columnSpacing={3}>
        <Grid item xs={4} sm={12} md={12}>
          ...
          >
            <Grid item xs={4} sm={12} md={12}>
              {opportunityData.installedsoftware.split(',').map((item, index, array) => (
                <React.Fragment key={index}>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={4} sm={12} md={12}>
                  <LocalizationProvider
                    ...
                    <DemoContainer components={['DatePicker']}>
                      ...
                      format="DD/MM/YYYY"
                      value={opportunityData.purchasedate}
                      onChange={(newValue)=>
                ...
                <Grid item xs={4} sm={12} md={12}>
                  <LocalizationProvider
                    ...
                    <DemoContainer components={['DatePicker']}>
                      ...
                      format="DD/MM/YYYY"
                      value={opportunityData.warrenty}
                      onChange={(newValue)=>
                ...
                <Grid item xs={4} sm={12} md={12}>
                  <TextField
                    ...
                    required
                    label="Purchase Cost"
                    value={opportunityData.purchasecost}
                    onChange={(event) => {
                ...
                <Grid item xs={4} sm={12} md={12}>
                  <TextField
                    ...
                    required
                    label="Order Number"
                    value={opportunityData.ordernumber}
                    onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            ...
                            size="small"
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === opportunityData.billedentity
                                ) || null
                              }
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === opportunityData.assignedentity
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                suppliers.find(
                                  (_supplier) =>
                                    _supplier.supplier_id === opportunityData.supplier
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                locations.find(
                                  (_location) =>
                                    _location.location_id === opportunityData.location
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                assetstatus.find(
                                  (_assetStatus) =>
                                    _assetStatus.status_id === opportunityData.assetStatus
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
      ...
      <TextField
        ...
        disabled
        label="Uploaded Invoice/PO"
        value={opportunityData.invoice}
        InputProps={{
          endAdornment: (
            <InputAdornment position="end">
              <IconButton
                onClick={()=>{window.open(`${API_URL}/uploads/${opportunityData.invoice}`, '_blank')}}
                edge="end"
              >
