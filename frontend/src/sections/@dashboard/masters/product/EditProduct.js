...
export default function EditProduct(props) {
  ...
  const softwareDetailsArray = productData.installedsoftware.split('", "');
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        await axios.get(`${API_URL}/api/products/${idToEdit}`).then((response) => {
  ...
  const validate = () => {
    ...
    if (!Boolean(productData.productName))
    ...
    const handleViewInvoice = () => {
      const invoiceUrl = `${API_URL}/uploads/${productData.invoice}`;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.put(`${API_URL}/api/products/${idToEdit}`, { ...productData, purchasedate: dayjs(productData.purchasedate).format("YYYY-MM-DD"),warrenty: dayjs(productData.warrenty).format("YYYY-MM-DD"), updatedBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>Product Edit | IT Asset Management</title>
      </Helmet>
                  ...
                  >
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.osmanufacturer}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.registeredowner}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.systemmanufacturer}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.windowsdirectory}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.systemdirectory}
                        onChange={(event) => {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        disabled
                        label="SystemLocale"
                        value={productData.systemlocale}
                        onChange={(event) => {
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      <Typography variant="body1" disabled="true">
                        {productData.installedsoftware.split(',').map((item, index) => (
                          <div key={index}>
      ...
      <Grid container columnSpacing={3}>
        <Grid item xs={4} sm={12} md={12}>
          ...
          >
            <Grid item xs={4} sm={12} md={12}>
              {productData.installedsoftware.split(',').map((item, index, array) => (
                <React.Fragment key={index}>
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            ...
                            size="small"
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === productData.billedentity
                                ) || null
                              }
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                companies.find(
                                  (_company) =>
                                    _company.company_id === productData.assignedentity
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                suppliers.find(
                                  (_supplier) =>
                                    _supplier.supplier_id === productData.supplier
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                locations.find(
                                  (_location) =>
                                    _location.location_id === productData.location
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
                    ...
                    <Grid item xs={4} sm={12} md={12}>
                            <Autocomplete
                              value={
                                assetstatus.find(
                                  (_assetStatus) =>
                                    _assetStatus.status_id === productData.assetStatus
                                ) || null
                              }
                              onChange={(event, newValue) => {
                                if (newValue) {
        ...
        InputProps={{
          endAdornment: (
            <InputAdornment position="end">
              <IconButton
                onClick={()=>{window.open(`${API_URL}/uploads/${productData.invoice}`, '_blank')}}
                edge="end"
              >
