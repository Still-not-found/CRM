...
export default function CreateProduct(props) {
  ...
  formData.append('file', selectedFile);
    ...
    try {
      ...
      // }
      await axios.post(`${API_URL}/api/products`, { ...productData, createdBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>Product Create | IT Assset Management</title>
      </Helmet>
                  ...
                  >
                    <Grid item xs={4} sm={12} md={12}>
                      <TextField
                        ...
                        value={productData.installedsoftware}
                        onChange={(event) => {
