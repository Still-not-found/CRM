...
export default function CreateSmartPhone(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(`${API_URL}/api/smartphones`, { ...smartphoneData, createdBy: loggedUser.user_id }).then((response) => {
  ...
  return (
    <>
      <Helmet>
        <title>SmartPhone Create | IT Assset Management</title>
      </Helmet>
